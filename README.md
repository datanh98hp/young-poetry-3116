...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/young-poetry-3116
```

A live public deployment of this template is available at [https://young-poetry-3116.templates.workers.dev](https://young-poetry-3116.templates.workers.dev)
